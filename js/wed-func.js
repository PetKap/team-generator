var tier1 = ["Adam", "Bodo", "Lukas K.", "Peto K.", "Peto L.", "Peto T.", "Tomas H.", "Jakub T."]
var tier2 = ["Janka", "Marcel B.", "Marek K.", "Matus P.", "Michal S.", "Peto B."]
var tier3 = ["Karci", "Libor V.", "Matus Ch.", "Miro H.", "Subi", "Vlado B.", "Viktor B."]
var tier4 = ["Janci K.", "Juro M.", "Martin K.", "Pato P.", "Richard K.", "Stevo P.", "Tomas C.", "Vlado R.", "Patrik K."]
var tier1Actual = []
var tier2Actual = []
var tier3Actual = []
var tier4Actual = []
