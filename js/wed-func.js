var tier1 = ["Bodo", "Lukas K.", "Peto T.", "Tomas H."]
var tier2 = ["Adam", "Janka", "Marcel B.", "Michal S.", "Peto K.", "Peto B.", "Peto L.", "Viktor B."]
var tier3 = ["Karci", "Libor V.", "Marek K.", "Matus Ch.", "Matus P.", "Miro H.", "Subi", "Vlado B."]
var tier4 = ["Janci K.", "Juro M.", "Martin K.", "Pato P.", "Riso", "Stevo P.", "Tomas C.", "Vlado R."]
var tier1Actual = []
var tier2Actual = []
var tier3Actual = []
var tier4Actual = []
